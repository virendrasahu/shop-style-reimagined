    ...
    <header className="sticky top-0 z-40 border-b bg-background">
      <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6">
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="w-[240px] sm:w-[300px]">
              <nav className="flex flex-col gap-4 mt-8">
                <Link to="/" className="text-lg font-medium">Shop</Link>
        ...
        <nav className="hidden md:flex items-center space-x-6">
          <Link to="/" className="text-sm font-medium hover:text-ecommerce-primary">Shop</Link>
          <Link to="/deals" className="text-sm font-medium hover:text-ecommerce-primary">Deals</Link>
          <Link to="/sale" className="text-sm font-medium hover:text-ecommerce-primary">Sale</Link>
